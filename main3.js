...
function clicked(){
    ...
    localStorage.setItem("GuessCount3", guessCount);
...
function saveData(){
    for(var i = 0; i < localStorage.getItem("length"); ++i){
        if(i == 0){
            localStorage.setItem("name1C", guesses[i]);
        }
        if(i == 1){
            localStorage.setItem("name2C", guesses[i]);
        }

        if(i == 2){
            localStorage.setItem("name3C", guesses[i]);
        }

        if(i == 3){
            localStorage.setItem("name4C", guesses[i]);
        }

        if(i == 4){
            localStorage.setItem("name5C", guesses[i]);
        }

        if(i == 5){
            localStorage.setItem("name6C", guesses[i]);
        }

        if(i == 6){
            localStorage.setItem("name7C", guesses[i]);
        }

        if(i == 7){
            localStorage.setItem("name8C", guesses[i]);
        }
    }
}
...
function loadData(){
    ...
    guessCount = localStorage.getItem("GuessCount3");

    i = guessCount;


    if(i == 1){
        guesses.push(localStorage.getItem("name1C"));
    }
    else if(i == 2){
        guesses.push(localStorage.getItem("name1C"));
        guesses.push(localStorage.getItem("name2C"));
    }
    else if(i == 3){
        guesses.push(localStorage.getItem("name1C"));
        guesses.push(localStorage.getItem("name2C"));
        guesses.push(localStorage.getItem("name3C"));
    }
    else if(i == 4){
        guesses.push(localStorage.getItem("name1C"));
        guesses.push(localStorage.getItem("name2C"));
        guesses.push(localStorage.getItem("name3C"));
        guesses.push(localStorage.getItem("name4C"));
    }
    else if(i == 5){
        guesses.push(localStorage.getItem("name1C"));
        guesses.push(localStorage.getItem("name2C"));
        guesses.push(localStorage.getItem("name3C"));
        guesses.push(localStorage.getItem("name4C"));
        guesses.push(localStorage.getItem("name5C"));
    }
    else if(i == 6){
        guesses.push(localStorage.getItem("name1C"));
        guesses.push(localStorage.getItem("name2C"));
        ...
        guesses.push(localStorage.getItem("name4C"));
        guesses.push(localStorage.getItem("name5C"));
        guesses.push(localStorage.getItem("name6C"));
    }
    else if(i == 7){
        guesses.push(localStorage.getItem("name1C"));
        guesses.push(localStorage.getItem("name2C"));
        ...
        guesses.push(localStorage.getItem("name5C"));
        guesses.push(localStorage.getItem("name6C"));
        guesses.push(localStorage.getItem("name7C"));
    }
    else if(i == 8){
    ...
    check(localStorage.getItem("name1C"));
    check(localStorage.getItem("name2C"));
    check(localStorage.getItem("name3C"));
    check(localStorage.getItem("name4C"));
    check(localStorage.getItem("name5C"));
    check(localStorage.getItem("name6C"));
    check(localStorage.getItem("name7C"));
    check(localStorage.getItem("name8C"));

    if(localStorage.getItem("result3") == "lost"){
        displayCorrect();
        togglePopup(messageLost1, messageLost2);
        document.getElementById("txtGuess").setAttribute("placeholder", "Game Over!");
    }
